package carlos.dev.games.core.utils;
...
public class PersistentDataContainerUtil {
    ...
    public static boolean hasString(ItemStack itemStack, String key) {
        if (itemStack.hasItemMeta()) {
            ...
            NamespacedKey namespacedKey = new NamespacedKey(MinecraftRPG.getInstance(), key);
    ...
    public static void putBoolean(String key, ItemStack itemStack) {
        ItemMeta itemMeta = itemStack.getItemMeta();
        NamespacedKey namespacedKey = new NamespacedKey(MinecraftRPG.getInstance(), key);
        PersistentDataContainer persistentDataContainer = itemMeta.getPersistentDataContainer();
