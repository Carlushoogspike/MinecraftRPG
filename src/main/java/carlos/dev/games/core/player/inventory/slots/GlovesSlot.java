...
public class GlovesSlot implements RPGSlotLeveler {

    private final PlayerInventory inventory;
    private double level;
    private double xp;

    public GlovesSlot(@NotNull Player player) {
    ...
    @Override
    public int getSlot() {
        return RPGSlotIndex.GLOVES.getSlot();
    }
    ...
    public ItemStack getReferenceItem() {
        ...
        meta.displayName(Component.text("§7Espaço para Luvas"));
