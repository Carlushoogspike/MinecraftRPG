...
public class AmuletSlot implements RPGSlotLeveler {

    private final PlayerInventory inventory;
    private double level;
    private double xp;

    public AmuletSlot(@NotNull Player player) {
    ...
    @Override
    public int getSlot() {
        return RPGSlotIndex.AMULET.getSlot();
    }
    ...
    public ItemStack getReferenceItem() {
        ...
        meta.displayName(Component.text("§7Espaço para Amuleto"));
