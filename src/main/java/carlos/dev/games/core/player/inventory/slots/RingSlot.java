...
public class RingSlot implements RPGSlotLeveler {

    private final PlayerInventory inventory;
    private double level;
    private double xp;

    public RingSlot(@NotNull Player player) {
    ...
    @Override
    public int getSlot() {
        return RPGSlotIndex.RING.getSlot();
    }
    ...
    public ItemStack getReferenceItem() {
        ...
        meta.displayName(Component.text("§7Espaço para Anel"));
